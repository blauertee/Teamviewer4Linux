Teamviewer4Linux
-----
A simple scripts that allows you to give technical support to you friends and family whom you've convinced to use Linux, withot them having to expose their machine to the internet.
